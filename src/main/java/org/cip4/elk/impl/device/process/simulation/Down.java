...
/**
 * Represents a Down simulation phase
 * 
 * @author Marco.Kornrumpf@Bertelsmann.de
 * 
 */
public class Down implements SimulationPhaseInterface {

	private static final JDFAutoDeviceInfo.EnumDeviceStatus SIMULATION_PHASE = JDFAutoDeviceInfo.EnumDeviceStatus.Down;
	...
	/**
	 * Generates a Down phase
	 * 
	 * @param phaseLength
	 *            in millis
	 * @param jmfComment
	 */
	public Down(long phaseLength, String jmfComment) {
	...
	/**
	 * @see org.cip4.elk.simlation.SimulationPhaseInterface#hasStatusDetails()
	 */
