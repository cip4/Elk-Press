...
/**
 * Tests if JMF can be sent to <code>org.cip4.elk.impl.jmf.LoggingJMFServlet</code>.
 * Requires that <code>LoggingJMFServlet</code> is deployed and listening at 
 ...
 */
public class SynchronousHttpOutgoingJMFDispatcherTest extends ElkTestCase {
     ...
     * @see SynchronousHttpOutgoingJMFDispatcherTest
     * @throws Exception
     */
